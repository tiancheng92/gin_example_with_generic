...
var errCodeDocPrefix = `# 系统错误码

系统错误码列表，由 {{.}}codegen -type=int -doc{{.}} 命令生成，<font color="#dd0000">**不要对此文件做任何更改**</font>。
...
func (v *Value) ParseComment() (string, string) {
	reg := regexp.MustCompile(`\w\s*-\s*(\d{3})\s*:\s*(.*)\s*\.\n*`)
